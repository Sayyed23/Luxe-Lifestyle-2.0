...
import { lifestyleArticles } from '../data/lifestyleArticles';
...
export default function ArticleDetail() {
  ...
  const getArticle = () => {
    if (category === 'fashion') {
      return fashionArticles[slug as keyof typeof fashionArticles];
    } else if (category === 'travel') {
      return travelArticles[slug as keyof typeof travelArticles];
    } else if (category === 'lifestyle') {
      return lifestyleArticles[slug as keyof typeof lifestyleArticles];
    }
    return null;
  };
